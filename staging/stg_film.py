...
with base as (
  select *
  from `mineral-voyage-442817-m2.pagila_productionpublic.film` --Your table path
  )
...
schema = [
    ...
    bigquery.SchemaField('film_rental_rate', 'DECIMAL'),
    bigquery.SchemaField('film_length', 'INTEGER'),
    bigquery.SchemaField('film_replacement_cost', 'DECIMAL'),
