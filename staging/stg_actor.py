...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/blahblah.json" # Edit path
...
project_id = 'your_project_id' # Edit with your project id
...
with base as (
  select *
  from `your_project_id.pagila_productionpublic.actor` --Your table path
  )
